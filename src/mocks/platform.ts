/* UI fixtures from the QOS design prototype.
   Shapes follow the staff-facing objects in src/db/schema.ts
   (tenants, catalogue products, locations, storefront releases, orders)
   without pretending these rows are database records. */
...
export const ORDER_TREND = [12, 18, 15, 24, 21, 30, 27, 34, 29, 38, 31, 26, 44, 39, 47, 41, 52, 48, 55, 43, 38, 30, 22, 16];
export const REVENUE_TREND = [8, 12, 11, 18, 16, 22, 20, 26, 23, 30, 26, 21, 34, 31, 37, 33, 41, 38, 44, 35, 30, 24, 18, 13];
