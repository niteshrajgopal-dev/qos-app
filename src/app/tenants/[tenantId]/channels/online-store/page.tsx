      ...
      <main className="mx-auto w-full max-w-5xl rounded-2xl border border-zinc-200 bg-white p-8 shadow-sm">
        <div className="mb-8 flex items-center justify-between gap-4">
          <div>
            ...
            <h1 className="mt-2 text-3xl font-semibold">Online Store</h1>
            <p className="mt-2 text-zinc-600">
              Publish immutable storefront releases and roll back without
              redeploying the shared renderer for tenant{" "}
