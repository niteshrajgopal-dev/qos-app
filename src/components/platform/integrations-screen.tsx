...
import { PageHeader, Card, Button, StatusBadge, Badge, Tabs, Breadcrumbs, Icon, Input, Select, Switch, Stepper, Alert, Modal, Toast, ToastStack, DataTable, Timeline, Chip, SearchInput, ProgressBar, AiBadge, EmptyState } from "@/design-system";
  ...
  return (
    <>
      ...
      <div style={{ marginTop: 20 }}>
        <Alert tone="error" title="Lightspeed POS is returning errors" actions={<Button size="sm" variant="secondary" onClick={() => setDetail(platform.INTEGRATIONS[0])}>Open integration</Button>}>
