...
import { PageHeader, Card, Button, DataTable, TableToolbar, TableBulkBar, Pagination, SearchInput, Chip, StatusBadge, Badge, Tabs, Breadcrumbs, Input, Select, Textarea, Switch, Checkbox, Banner, Toast, ToastStack, Icon, IconButton, Tag, EmptyState, AiBadge } from "@/design-system";
      ...
      <div style={{ marginTop: 20 }}>
        <Card padding="none">
          ...
          <DataTable
            ...
            onToggleAll={(n) => setSel(n ? platform.PRODUCTS.map((r) => r.id) : [])}
