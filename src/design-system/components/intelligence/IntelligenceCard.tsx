...
export function IntelligenceCard({ kind = "Insight", title, claims = [], children, actions, confidence, ...rest }: IntelligenceCardProps) {
  return (
...
export function AiBadge({ children = "AI", ...rest }: AiBadgeProps) {
  return (
