...
export function Sparkline({ values = [], width = 96, height = 28, tone = "var(--viz-1)", ...rest }: SparklineProps) {
  return (
...
export function BarChart({ data = [], height = 180, valueFormat = (v) => v, ...rest }: BarChartProps) {
...
export function ChartLegend({ items = [], ...rest }: ChartLegendProps) {
  return (
