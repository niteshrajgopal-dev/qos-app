...
export function StatusBadge({ state, label, ...rest }: StatusBadgeProps) {
  const key = (state in QOS_STATES ? state : "info") as keyof typeof QOS_STATES;
  const cfg = QOS_STATES[key];
