...
export function CommandPalette({ open = true, query = "", onQueryChange, groups = [], onSelect, onClose, placeholder = "Search businesses, orders, products, locations…", ...rest }: CommandPaletteProps) {
